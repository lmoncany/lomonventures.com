...
const englishPages = {
  ...
  offers: {
    ...
    sections: [
      ["Ship · €99", "The production-ready foundation used for Lomon products. Clone it, deploy it, and start from a clean base.", "/#ship"],
      ["Build · €5,000", "A 30-day product sprint for business owners who need the first useful version shipped and handed over.", "/#build"],
      ["VibeDoctor", "You built it with AI. It almost works. I diagnose the fragile parts, fix the critical issues, and help you finish it."],
    ],
  },
  about: {
    code: "ABOUT",
...
export const marketingPages: Record<SiteLocale, Record<MarketingPageKey, MarketingPageContent>> = {
  ...
  fr: {
    ...
    offers: { ...englishPages.offers, eyebrow: "Travailler ensemble", title: "Commencer seul, lancer la demande ou faire construire le produit.", intro: "Lomon Ventures aide les dirigeants à transformer workflows, idées et prototypes IA incomplets en logiciels utiles, sans agence lourde ni freelance à gérer.", primary: "Parlez-moi de votre projet", note: "Travail direct. Scope clair. Vous possédez ce qui est livré.", sections: [["Ship · 99 €", "La base technique prête pour produire, déployer et démarrer proprement.", "/fr#ship"], ["Build · 5 000 €", "Un sprint produit de 30 jours pour livrer et transmettre la première version utile.", "/fr#build"], ["VibeDoctor", "Vous l'avez construit avec l'IA. Il fonctionne presque. Je diagnostique les parties fragiles, corrige les problèmes critiques et vous aide à le terminer."]] },
  ...
  it: {
    ...
    offers: { ...englishPages.offers, eyebrow: "Come lavorare insieme", title: "Inizia da solo, lancia la domanda o fai costruire il prodotto.", intro: "Lomon Ventures aiuta business owner a trasformare workflow, idee e prototipi AI incompleti in software utile, senza agenzia pesante o freelance da gestire.", primary: "Raccontami cosa vuoi costruire", note: "Lavoro diretto. Scope chiaro. Il codice resta tuo.", sections: [["Ship · €99", "La base tecnica pronta per produrre, deployare e iniziare pulito.", "/it#ship"], ["Build · €5.000", "Uno sprint prodotto di 30 giorni per consegnare la prima versione utile.", "/it#build"], ["VibeDoctor", "L'hai costruito con l'AI. Funziona quasi. Diagnostico le parti fragili, risolvo i problemi critici e ti aiuto a finirlo."]] },
