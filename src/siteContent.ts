...
export const homepageCopy: Record<SiteLocale, HomepageContent> = {
  en: {
    chip: "Software that catches up with your business",
    h1Lead: "Your business evolved.",
    h1Accent: "Your software didn't. We fix that.",
    sub: "Lomon Ventures re-builds the tools your team has been working around for years — built around how you actually operate today, not how someone assumed you would in 2010. ",
    subHighlight: "",
    proof: ["6 products in production", "15+ years building for the web", "Senior hands from day one"],
    actionNote: "Say HI. First response immediately. 100% Human. 0% AI. No commitment. Full value.",
    ...
    s01h2Lead: "What takes 30 minutes",
    s01h2Accent: "should take 2.",
    s01body: [
      "Your team stopped complaining. They just learned to work around it.",
      "Excel exports. Copy-pasting between two systems that don't talk to each other. Workarounds only one person on the team actually understands.",
      "That's not a training problem. That's not a motivation problem.",
      "That's software that didn't evolve with your business.",
      "The real cost isn't in the licence fee. It's in the 30 minutes lost, per person, per task, every day.",
    ],
    s01statement: "That's exactly what Lomon Ventures rebuilds.",
    ...
    comparisonHeaders: ["", "Do It Yourself", "Validate Before Coding", "Build", "Freelancer", "Agency"],
    ...
    comparison: [
      ["What happens", "Pay a monthly AI subscription and try to stitch the pieces together yourself.", "We do a high-conversion landing page with a waiting list. You share it with your audience and see if it fits.", "You validated. We team up to make it real in 30 days.", "You manage scope, quality, availability, and handoffs yourself.", "Prepare your wallet and the BS talks."],
      ["Best when", "You have time, technical patience, and low stakes.", "You need market signal before writing real code.", "The workflow is real and the demand is already visible.", "You already know exactly what to build and how to review it.", "You need a large team, procurement, and ceremony."],
      ["Main risk", "You get a demo, not an operational tool.", "You validate interest, not the full product.", "Scope discipline is mandatory.", "You become the product manager by default.", "Expensive meetings replace useful progress."],
    ],
    fit: [
  ...
  fr: {
    chip: "Vous vous sentez piégés ?",
    h1Lead: "Votre entreprise a évolué.",
    h1Accent: "Vos logiciels n'ont pas suivis. On est la.",
    sub: "Lomon Ventures reconstruit les outils autour desquels vos équipes travaillent depuis des années conçus pour la façon dont vous opérez aujourd'hui. Ce qui vous pourrait vous prendre 2 minutes aujourd'hui vous prends 30minutes parceque l'outil que vous utilisez est soit : trop vieux ou trop compliqué. ",
    subHighlight: "",
    proof: ["6 produits en production", "15+ ans de développement web", "Expertise senior dès le premier jour"],
    actionNote: "Réponse honnête sous 48 heures. Sans engagement.",
    seenOnLabel: "Vu sur",
    trustLabel: "“Loic is a secret weapon in web dev.” — Teri Yu, Product @ OpenAI · Ex Vibely",
    ...
    s01h2Lead: "Ce qui vous prend 30 minutes",
    s01h2Accent: "devrait en prendre 2.",
    s01body: [
      "Votre équipe ne se plaint plus. Elle a juste appris à contourner.",
      "Des exports Excel. Des copier-coller entre deux systèmes qui ne se parlent pas. Des raccourcis bricolés que seule une personne dans l'équipe comprend vraiment.",
      "Ce n'est pas un problème de formation. Ce n'est pas un problème de motivation.",
      "C'est un logiciel qui n'a pas évolué avec votre business.",
      "Le vrai coût n'est pas dans la licence. Il est dans les 30 minutes perdues, par personne, par tâche, chaque jour.",
    ],
    s01statement: "C'est exactement ce que Lomon Ventures reconstruit.",
    ...
    comparisonHeaders: ["", "Do It Yourself", "Valider avant de coder", "Build", "Freelance", "Agence"],
    ...
    comparison: [
      ["Ce qui se passe", "Vous payez un abonnement IA mensuel et essayez d'assembler les morceaux vous-même.", "On construit une landing page à forte conversion avec une liste d'attente. Vous la partagez à votre audience et vous voyez si ça prend.", "Vous avez validé. On fait équipe pour le rendre réel en 30 jours.", "Vous gérez vous-même scope, qualité, disponibilité et handoffs.", "Préparez le portefeuille et les discours bullshit."],
      ["Idéal si", "Vous avez du temps, de la patience technique et peu d'enjeu.", "Vous avez besoin d'un signal marché avant d'écrire du vrai code.", "Le workflow est réel et la demande est déjà visible.", "Vous savez exactement quoi construire et comment le vérifier.", "Vous avez besoin d'une grosse équipe, de procurement et de cérémonie."],
      ["Risque principal", "Vous obtenez une démo, pas un outil opérationnel.", "Vous validez l'intérêt, pas tout le produit.", "La discipline de scope est obligatoire.", "Vous devenez product manager par défaut.", "Les réunions chères remplacent le progrès utile."],
    ],
    fit: [
  ...
  it: {
    chip: "Software su misura per workflow business reali",
    h1Lead: "Costruiamo\nstrumenti adatti\nal tuo business.",
    ...
    comparisonHeaders: ["", "Do It Yourself", "Valida prima del codice", "Build", "Freelance", "Agenzia"],
    s06kicker: "06 / Portfolio",
    ...
    comparison: [
      ["Cosa succede", "Paghi un abbonamento AI mensile e provi ad assemblare i pezzi da solo.", "Costruiamo una landing page ad alta conversione con waiting list. La condividi con il tuo pubblico e vedi se c'è fit.", "Hai validato. Facciamo team per renderlo reale in 30 giorni.", "Gestisci da solo scope, qualità, disponibilità e handoff.", "Prepara il portafoglio e i discorsi bullshit."],
      ["Ideale se", "Hai tempo, pazienza tecnica e posta in gioco bassa.", "Ti serve segnale di mercato prima di scrivere vero codice.", "Il workflow è reale e la domanda è già visibile.", "Sai già esattamente cosa costruire e come verificarlo.", "Ti serve un grande team, procurement e cerimonia."],
      ["Rischio principale", "Ottieni una demo, non uno strumento operativo.", "Validi l'interesse, non tutto il prodotto.", "Serve disciplina assoluta sullo scope.", "Diventi product manager per default.", "Riunioni costose sostituiscono progresso utile."],
    ],
    fit: [
